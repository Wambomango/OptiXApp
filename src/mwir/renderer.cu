...
void Renderer::PrepareRendering(Scene &scene, std::optional<int> seed)
{
...
torch::Tensor Renderer::AllocateResultTensor(std::optional<torch::Tensor> opt_result_tensor)
{
