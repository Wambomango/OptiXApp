...
Pipeline::Pipeline()
{
    ...
    module = std::make_unique<OptiX::Module>(ctx, std::string("RendererModule"), MODULE_DIR + std::string("render_module.cu"), module_compile_options, pipeline_compile_options);
