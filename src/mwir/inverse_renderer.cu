...
InverseRenderer::InverseRenderer() : inverse_pipeline()
{    
...
torch::Tensor InverseRenderer::AllocateResultTensor(std::optional<torch::Tensor> opt_result_tensor)
{
...
void InverseRenderer::RenderAntenna(int sender_index)
{
