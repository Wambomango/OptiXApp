...
for i in range(n_angles):
    ...
    mesh_vertices = torch.tensor([[0, -1, -1], [0, 1, 1], [0, 1, -1], [0, -1, -1], [0, -1, 1], [0, 1, 1]], dtype=torch.float32) @ rotation_matrix.T * plate_scale + torch.tensor([plate_distance, 0, 0], dtype=torch.float32)
