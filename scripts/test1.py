...
test = torch.ones(1, 5, 5, 5, dtype=torch.float32) * 1
# test[0,1,1,1] = 1.0
# test[0, 1:4, :, :] = 1
padded_test = torch.nn.functional.pad(test, (1, 1, 1, 1, 1, 1), mode='constant', value=-10000)


vertices, indices = marching_cubes.marching_cubes(padded_test, 0.5)
vertices = vertices[0]
